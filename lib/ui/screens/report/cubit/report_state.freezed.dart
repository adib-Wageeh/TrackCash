...
abstract class Success implements ReportState {
...
class __$$ErrorDetailsImplCopyWithImpl<$Res>
    extends _$ReportStateCopyWithImpl<$Res, _$ErrorDetailsImpl>
...
class _$ErrorDetailsImpl implements ErrorDetails {
  ...
  @override
  String toString() {
    return 'ReportState.error(failure: $failure)';
  }
...
abstract class ErrorDetails implements ReportState {
